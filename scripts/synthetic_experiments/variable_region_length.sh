...
num_datasets=10
out_dir="synthetic_data/synthetic_experiments/variable_region_length/"
window_size="6H"
num_points_per_window=6
point_frequency="1H"
confidence_interval_width=0.97
...
seed_start=1
inj_region_length_start=24
inj_region_length_step_size=4
inj_region_length_num_increments=10
...
mdi_extint_max_len=64
mdi_td_dim=0
mdi_td_lag=0

for i in $(seq 0 $inj_region_length_num_increments);
do

    max_length=$(($i*$inj_region_length_step_size+$inj_region_length_start))
    min_length=$(($inj_region_length_start))

    for seed in $(seq $seed_start $num_datasets);
    do  
        # Data Generation
        python synthetic_data_generator.py -o $out_dir/length_$min_length\_$max_length/seed$seed/ \
        ...
        --inj_num_regions $inj_num_regions --variable_inj_region_length $min_length $max_length --outlier_injection_rate $injection_rate \
        --seed $seed --white_noise_std $white_noise_std --aggregation_model aggregate_prophet_model

        # Fixed Bandwidth
        python simulate_streaming.py --output_dir $out_dir/length_$min_length\_$max_length/seed$seed/evaluation/fixed_bandwidth/ \
        --input_time_series_df $out_dir/length_$min_length\_$max_length/seed$seed/df.pickle \
        --regions_df $out_dir/length_$min_length\_$max_length/seed$seed/regions_df.pickle \
        ...
        # ISJ Bandwidth
        python simulate_streaming.py --output_dir $out_dir/length_$min_length\_$max_length/seed$seed/evaluation/isj_bandwidth/ \
        --input_time_series_df $out_dir/length_$min_length\_$max_length/seed$seed/df.pickle \
        --regions_df $out_dir/length_$min_length\_$max_length/seed$seed/regions_df.pickle \
        --num_points_in_history 10080 --streaming_num_points_step 4 --confidence_interval_width $confidence_interval_width \
        --aggregation_model aggregate_prophet_model \
        ...
        python simulate_streaming.py --output_dir $out_dir/length_$min_length\_$max_length/seed$seed/evaluation/isj_bandwidth_adj_local_min/ \
        --input_time_series_df $out_dir/length_$min_length\_$max_length/seed$seed/df.pickle \
        --regions_df $out_dir/length_$min_length\_$max_length/seed$seed/regions_df.pickle \
        --num_points_in_history 10080 --streaming_num_points_step 4 --confidence_interval_width $confidence_interval_width \
        --aggregation_model aggregate_prophet_model \
        ...
        python libmaxdiv/get_mdi_regions.py --output_dir $out_dir/length_$min_length\_$max_length/seed$seed/evaluation/mdi/ \
        --input_time_series_df $out_dir/length_$min_length\_$max_length/seed$seed/df.pickle \
